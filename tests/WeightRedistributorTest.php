...
class WeightRedistributorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testWeightRedistribution()
    {
        ...
        $box = new TestBox('Box', 370, 375, 60, 140, 364, 374, 40, 3000, 100);
        $boxList = new BoxList();
        $boxList->insert($box);

        $item1 = new TestItem('Item #1', 230, 330, 6, 320, 1, true);
        $item2 = new TestItem('Item #2', 210, 297, 5, 187, 1, true);
        $item3 = new TestItem('Item #3', 210, 297, 11, 674, 1, true);
        $item4 = new TestItem('Item #4', 210, 297, 3, 82, 1, true);
        $item5 = new TestItem('Item #5', 206, 295, 4, 217, 1, true);
        ...
        $packedBox1 = new PackedBox($box, $box1Items, 0, 0, 0, 0, 0);
        $packedBox2 = new PackedBox($box, $box2Items, 0, 0, 0, 0, 0);
        $packedBox3 = new PackedBox($box, $box3Items, 0, 0, 0, 0, 0);
